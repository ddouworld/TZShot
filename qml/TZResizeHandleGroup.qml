...
Rectangle{
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            onPressed: {
                let globalPos = leftTop.mapToItem(null, mouseX, mouseY);
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            onPressed: {
                let globalPos = top.mapToItem(null, mouseX, mouseY);
                mousePointStart.y = globalPos.y
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            onPressed: {
                let globalPos = rightTop.mapToItem(null, mouseX, mouseY);
                mousePointStart.x = globalPos.x
                mousePointStart.y = globalPos.y
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            onPressed: {
                let globalPos = right.mapToItem(null, mouseX, mouseY);
                mousePointStart.x = globalPos.x
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            cursorShape: Qt.SizeFDiagCursor
            onPressed: {
                let globalPos = rightButtom.mapToItem(null, mouseX, mouseY);
                mousePointStart.x = globalPos.x
                mousePointStart.y = globalPos.y
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            cursorShape: Qt.SizeVerCursor
            onPressed: {
                let globalPos = buttom.mapToItem(null, mouseX, mouseY);
                mousePointStart.y = globalPos.y
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            cursorShape: Qt.SizeBDiagCursor
            onPressed: {
                let globalPos = leftBottom.mapToItem(null, mouseX, mouseY);
                mousePointStart.x = globalPos.x
                mousePointStart.y = globalPos.y
                initialArea = area
            }
    ...
    TZResizeHandle
    {
        ...
        MouseArea {
            ...
            cursorShape: Qt.SizeHorCursor
            onPressed: {
                let globalPos = left.mapToItem(null, mouseX, mouseY);
                mousePointStart.x = globalPos.x
                initialArea = area
            }
